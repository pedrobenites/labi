...
function (_Component) {
  ...
  function DragElement() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DragElement)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dragStart", function (_ref2) {
      var clientX = _ref2.clientX;
      _this.props.isMoving && _this.props.isMoving(true);
      var referenceDelta = _this.state.delta;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dragMove", function (_ref3) {
      var clientX = _ref3.clientX;
      if (!_this.state.moving) return null;
      var delta = _this.state.referenceDelta + _this.state.x - clientX;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dragEnd", function () {
      _this.props.isMoving && _this.props.isMoving(false);
    ...
    get: function get() {
      ...
      return {
        ...
        onTouchStart: function onTouchStart(event) {
          return _this2.dragStart(event.changedTouches[0]);
        },
        onTouchMove: function onTouchMove(event) {
          return _this2.dragMove(event.changedTouches[0]);
        },
...
//# sourceMappingURL=06-glossario.js.329e0b3b71e45d8f58e0.hot-update.js.map