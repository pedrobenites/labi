...
function (_Component) {
  ...
  function HistoryCard() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateTime", function () {
      _this.setState({
        currentTime: _this._audio.current.currentTime
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "render", function () {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        ref: _this._audio,
        controls: true,
        onTimeUpdate: function onTimeUpdate(_ref) {
          var target = _ref.target;
          return console.log(target.currentTime);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 65
...
var CardBody = function CardBody(_ref3) {
  var _ref3$playlist = _ref3.playlist,
      playlist = _ref3$playlist === void 0 ? [] : _ref3$playlist,
...
var Sound = function Sound(_ref4) {
...
//# sourceMappingURL=02-colocando-em-pratica.js.c019e1c1a5ec20adb548.hot-update.js.map