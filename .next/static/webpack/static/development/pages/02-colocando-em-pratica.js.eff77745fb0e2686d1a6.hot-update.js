...
function (_Component) {
  ...
  function HistoryCard() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      console.log(_this.props.playlist); //this.setState({ quantify: this.props.playlist.length })
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "render", function () {
      if (!_this.props.playlist && !!_this.props.playlist.length) return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
//# sourceMappingURL=02-colocando-em-pratica.js.eff77745fb0e2686d1a6.hot-update.js.map