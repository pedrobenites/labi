  ...
  function HistoryCard() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateTime", function (_ref) {
      ...
      if (currentTime === _this.state.duration) {
        ...
        if (newPosition < _this.state.quantify) return _this.setPosition(newPosition);
        return null;
      }
...
//# sourceMappingURL=02-colocando-em-pratica.js.bfd1056018f75467854e.hot-update.js.map